...
import { getHeroImages, getPrimaryHeroImage } from "./heroImages.js";
...
export const pages = [
  {
    ...
    heroImage: getPrimaryHeroImage("despre-noi"),
    heroImages: getHeroImages("despre-noi"),
  ...
  },
  {
    ...
    heroImage: getPrimaryHeroImage("program-liturgic"),
    heroImages: getHeroImages("program-liturgic"),
  ...
  },
  {
    ...
    heroImage: getPrimaryHeroImage("botez"),
    heroImages: getHeroImages("botez"),
  ...
  },
  {
    ...
    heroImage: getPrimaryHeroImage("spovedanie"),
    heroImages: getHeroImages("spovedanie"),
  ...
  },
  {
    ...
    heroImage: getPrimaryHeroImage("donatii"),
    heroImages: getHeroImages("donatii"),
  ...
  },
  {
    ...
    heroImage: getPrimaryHeroImage("fundatia-noastra"),
    heroImages: getHeroImages("fundatia-noastra"),
    icon: siteConfig.logo,
    navGroup: "Informații",
  ...
  },
  {
    ...
    heroImage: getPrimaryHeroImage("viata-sfintei-parascheva"),
    heroImages: getHeroImages("viata-sfintei-parascheva"),
    icon: siteConfig.logo,
    navGroup: "Informații",
  ...
  },
  {
    ...
    heroImage: getPrimaryHeroImage("acatistul-sfintei-parascheva"),
    heroImages: getHeroImages("acatistul-sfintei-parascheva"),
    icon: siteConfig.logo,
    navGroup: "Informații",
  ...
  },
  {
    ...
    heroImage: getPrimaryHeroImage("parohii-olanda"),
    heroImages: getHeroImages("parohii-olanda"),
    icon: siteConfig.logo,
    navGroup: "Informații",
  ...
  },
  {
    ...
    heroImage: getPrimaryHeroImage("parohii-belgia"),
    heroImages: getHeroImages("parohii-belgia"),
    icon: siteConfig.logo,
    navGroup: "Informații",
  ...
  },
  {
    ...
    heroImage: getPrimaryHeroImage("contact"),
    heroImages: getHeroImages("contact"),
    icon: siteConfig.logo,
    navGroup: "Contact",
